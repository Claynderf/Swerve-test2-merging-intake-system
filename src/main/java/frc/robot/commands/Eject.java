  ...
  public void initialize() {
    fuelSubsystem
        .setIntakeLauncherRoller(
            -1 * SmartDashboard.getNumber("Intaking intake roller value", INTAKING_LAUNCHER_POWER));
    fuelSubsystem
        .setFeederRoller(1 * SmartDashboard.getNumber("Intaking feeder roller value", INTAKING_FEEDER_POWER));
  }
