...
public final class Constants {
  ...
  public static final class FuelConstants {
    ...
    public static final double INTAKING_LAUNCHER_VOLTAGE = -6;
    public static final double LAUNCHING_FEEDER_VOLTAGE = 9;
    public static final double LAUNCHING_LAUNCHER_VOLTAGE = -10.6;
    public static final double SPIN_UP_FEEDER_VOLTAGE = -6;
    public static final double SPIN_UP_SECONDS = 0.5;*/
    public static final double INTAKING_FEEDER_VOLTAGE = 0.75;
    public static final double INTAKING_LAUNCHER_VOLTAGE = -0.5;
    public static final double LAUNCHING_FEEDER_VOLTAGE = 1;
    public static final double LAUNCHING_LAUNCHER_VOLTAGE = -1;
    public static final double SPIN_UP_FEEDER_VOLTAGE = -0.75;
